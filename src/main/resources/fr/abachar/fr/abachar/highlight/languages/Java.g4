...
classOrInterfaceModifier
    ...
    |   (   'public'     { addFragment(Type.KEYWORD, $start); }
        |   'protected'  { addFragment(Type.KEYWORD, $start); }
        |   'private'    { addFragment(Type.KEYWORD, $start); }
        |   'static'     { addFragment(Type.KEYWORD, $start); }
        |   'abstract'   { addFragment(Type.KEYWORD, $start); }
        |   'final'      { addFragment(Type.KEYWORD, $start); }
        |   'strictfp'   { addFragment(Type.KEYWORD, $start); }
        )
    ;
